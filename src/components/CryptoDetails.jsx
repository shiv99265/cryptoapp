...
const CryptoDetails = () => {
  ...
  const [ count, setCount] = useState('7d');
  
  // console.log(data);
  const time = ['3h', '24h', '7d', '30d', '1y', '3m', '3y', '5y'];
  const { data: coinHistory } = useGetCryptoHistoryQuery({ uuid, count });
  ...
  const pass = cryptoDetails.description;
  // console.log(rank);
  return (
    <Col className = "coin-detail-container">
     ...
     placeholder = "Select Count" onChange = {(value)=> setCount(value)}
     >
